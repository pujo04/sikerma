// API configuration - menggunakan route Next.js internal
// Saat ini pakai API routes Next.js (port 3000)
// Untuk terhubung ke backend terpisah, ubah NEXT_PUBLIC_API_URL di .env.local
...
export const API = {
  ...
  // Repository sub-resource detail (with ID)
