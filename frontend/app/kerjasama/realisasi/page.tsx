...
export default function RealisasiKegiatanPage() {
  ...
  const fetchBentukKegiatan = async (repositoryId: string) => {
    ...
    const res = await fetch(
      API.repositoryDetailBentuk(repositoryId)
    )
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await fetch(API.realise);
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(API.realiseDetail(deleteRealisasi.id.toString()), {
        method: "DELETE",
      });
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const url = editingId
                      ? API.realiseDetail(editingId.toString())
                      : API.realise
